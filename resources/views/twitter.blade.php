...
<body class="font-sans antialiased h-full bg-black text-white">
    ...
    <div class="container mx-auto grid grid-cols-4 h-full">
        ...
        <div class="col-span-2 border-x-[0.625px] border-lines relative ">
            ...
            <div
                class="text-center text-twitter font-semibold py-4 bg-transparent hover:bg-opacity-20 hover:bg-gray-900 cursor-pointer">
                Show 245 tweets
            </div>
        ...
        <div class="mt-2 pl-6 space-y-6">
            ...
            <div class="rounded-2xl border-lines border-[0.625px] min-h-40 px-4 py-2">
                ...
                <div class="flex align-top space-x-2 mt-4">
                    <div>
                        <img alt="Ademiro" draggable="true" class="rounded-full"
                             src="https://pbs.twimg.com/profile_images/1203099215687278593/7HILy1EW_normal.jpg"
                        />
                    </div>
                    ...
                    <div class="w-full">
                        <div class="flex justify-between w-full">
                            <div>
                                <div class="text-white font-bold text-base">Ademiro</div>
                        ...
                        <div class="text-[15px] mt-1">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus risus cursus ornare
                            luctus. Vestibulum aliquam.
                        </div>
